...
import static eu.captag.util.SnackbarFactory.createSnackbar;
import static eu.captag.util.SnackbarFactory.createErrorSnackbar;
import static eu.captag.util.SnackbarFactory.createSuccessSnackbar;
